...
import com.db.dao.ProductDaoImp1;
...
public class ProductUI {
    ...
    public static void main(String[] args) {
        ...
        Product p = null;
        ProductDaoImp1 pimpl = new ProductDaoImp1();
        Boolean flag;
        ...
        while (!exit) {
            ...
            option = sc.nextInt();
            sc.nextLine(); // consume the newline character after reading the option
            ...
            switch (option) {
                case 1:
                    ...
                    if (flag)
                        ...
                        System.err.println("Error while adding the product to the database");
                    break;
